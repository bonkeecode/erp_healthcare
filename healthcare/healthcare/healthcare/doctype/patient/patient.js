...
//         patient_name.defaults() = "Kenneth Sy"
//     }, __("action"));
// 	frm.add_custom_button(('Action 2'), function(){
//         patient_name.defaults() = "Blind"
//     }, __("action"));
...
//     refresh: function(frm) {
//       frm.add_custom_button(('Action 1'), function(){
// 		cur_frm.set_value("first_name", "bakokang");
...
//         frm.add_custom_button(('Action 1'), function(){
// 			cur_frm.set_value("first_name", x;
// 			frappe.msgprint(first_name);
//     }, __("action"));
...
frappe.ui.form.on('Patient', {
    refresh: function(frm) {
      ...
      frm.add_custom_button(__('Action 1'), function(){
        cur_frm.set_value("first_name", "Kenneth Sy");
//         
    }, __("Action"));
    
	frm.add_custom_button(__('Action 2'), function(){
        cur_frm.set_value("first_name", "Blind");
//         
    }, __("Action"));

	frm.add_custom_button(__('Action 3'), function(){
        cur_frm.set_value("first_name", frm.doc.patient_name);
//         
    }, __("Action"));
